...
Protocol (compatible with ``openpi_client.websocket_client_policy.WebsocketClientPolicy``):
  ...
  - Payload/result are python dicts serialized with msgpack + the msgpack-numpy
    extension (numpy arrays travel inline).
...
def main() -> None:
    ...
    parser.add_argument("--action-denoise-steps", type=int, default=10, help="Async action/proprio denoising steps (0 = joint).")
